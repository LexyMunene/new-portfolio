    ...
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
        <Card 
            ...
            description="I start by understanding the project requirements and planning the design and development process."
            >
            <CanvasRevealEffect
              animationSpeed={5.1}
        ...
        <Card 
            ...
            description="Once we agree on the plan, I start on developing the project and keep you updated on the progress."
            >
            <CanvasRevealEffect
              animationSpeed={3}
        ...
        <Card  
            ...
            description="I make sure the project is ready for launch and provide support after the project is done."
            >
            <CanvasRevealEffect
              animationSpeed={3}
